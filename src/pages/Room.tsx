...
export function Room() {
    ...
    const [buttonSendQuestionContent, setButtonSendQuestionContent ] = useState(<>Enviar pergunta</>);
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        if (newQuestion.trim() === '') {
            ...
            if (!user) {
                ...
                setButtonSendQuestionContent(<><img src={loadingIcon} alt="Loading Icon"/></>)
                const question = {
                    content: newQuestion,
                    author: {
                        name: user.user?.name,
            ...
            <main className="content">
                ...
                <form onSubmit={handleSendQuestion}>
                    ...
                    <div className="form-footer">
                        ...
                        <Button type="submit" disabled={!user}> { buttonSendQuestionContent } </Button>
                    </div>
                </form>
